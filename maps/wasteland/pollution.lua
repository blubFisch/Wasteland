...
local pollution_index = {
    ...
    ['crash-site-spaceship-wreck-small-1'] = {min = 0.2, max = 0.4},
    ['crash-site-spaceship-wreck-small-2'] = {min = 0.2, max = 0.4},
    ['crash-site-spaceship-wreck-small-3'] = {min = 0.2, max = 0.4},
