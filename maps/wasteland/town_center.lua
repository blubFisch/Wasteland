...
local function found_town(event)
    ...
    town_center.shield_text = rendering.draw_text {
        ...
        surface = surface,
        forces = {force_name},
        target = {entity = town_center.market, offset = {0, -0.25}},
        color = {200, 200, 200},
        scale = 1.00,
        font = 'default-game',
        alignment = 'center',
    ...
    for _, e in pairs(surface.find_entities_filtered({force = 'enemy', type = {'unit-spawner', 'unit', 'turret', 'ammo-turret'},
    ...
    force.copy_chart(player.force, surface, surface)
