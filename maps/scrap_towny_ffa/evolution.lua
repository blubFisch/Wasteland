...
local technology_weights = {
    ...
    ['power-armor'] = {biter = 50, spitter = 50, worm = 50},
    ['power-armor-mk2'] = {biter = 50, spitter = 50, worm = 50},
    ...
    ['refined-flammables-7'] = {biter = 5, spitter = 5, worm = 5},
    ...
    ['space-science-pack'] = {biter = 500, spitter = 500, worm = 500},
    ...
    ['stronger-explosives-7'] = {biter = 5, spitter = 5, worm = 5},
    ['sulfur-processing'] = {biter = 1, spitter = 1, worm = 1},
    ['tank'] = {biter = 50, spitter = 50, worm = 50},
